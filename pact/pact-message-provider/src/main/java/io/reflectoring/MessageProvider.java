...
public class MessageProvider {
  ...
  @Autowired
  public MessageProvider(RabbitTemplate rabbitTemplate, TopicExchange topicExchange) {
  ...
  public void sendMessage() {
    ...
    String message = String.format("Message no. %d of type '%s'", ++messageNumber, routingKey);
