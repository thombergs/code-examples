...
import io.reflectoring.solid.lsp.paymentexample.common.PaymentProcessor;
...
import io.reflectoring.solid.lsp.paymentexample.violation.instruments.RewardsCard;
import java.util.Date;
import java.util.Scanner;

public class LSPViolationMainApp {
    public static void main(String[] args) {
        System.out.println("This program simulates the different flows through the payment system.");
        System.out.println("This version adds a new class RewardsCard to the class hierarchy and demonstrates"
            + " LSP violation.");
        System.out.println();
        ...
        System.out.println("7. Rewards card attempt - broken app flow");
        ...
        switch (flow) {
            ...
            case 7:
                ...
                RewardsCard card7 = new RewardsCard(name, cardNum7, null, null);
                ...
                System.out.println("Rewards card payment failed!");
