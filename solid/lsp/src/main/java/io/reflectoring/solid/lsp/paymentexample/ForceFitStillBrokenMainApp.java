...
import io.reflectoring.solid.lsp.paymentexample.forcefit.instruments.RewardsCard;
import java.util.Date;
import java.util.Scanner;

public class ForceFitStillBrokenMainApp {
    public static void main(String[] args) {
        ...
        System.out.println("This version shows how force-fitting the new class RewardsCard "
            + "into the current class hierarchy still violates LSP.");
        System.out.println();
